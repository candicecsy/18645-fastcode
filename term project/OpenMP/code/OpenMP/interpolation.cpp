...
void zoom(float ratioX, float ratioY) {
    ...
    cout << "Time for zooming the input picture with " + to_string(ratioX) + "x is: " << (double)(endTime - startTime) / CLOCKS_PER_SEC << "s" << endl;
...
void translate(int offsetX, int offsetY) {
    ...
    for (int z = 0; z < zMaxOut; z++) {
        ...
        for (int x = 0; x < xMaxOut; x++) {
            ...
            for (; y <= yMaxOut - 4; y += 4) {
                ...
                if (coordinateX >= 0 && coordinateX < xMax
                    && coordinateY >= 0 && coordinateY < yMax) {
                    pixelsOut[z][x][y + 1] = pixels[coordinateZ][coordinateX][coordinateY];
                } else {
                    pixelsOut[z][x][y + 1] = 255;
                }
                ...
                if (coordinateX >= 0 && coordinateX < xMax
                    && coordinateY >= 0 && coordinateY < yMax) {
                    pixelsOut[z][x][y + 2] = pixels[coordinateZ][coordinateX][coordinateY];
                } else {
                    pixelsOut[z][x][y + 2] = 255;
                }
                ...
                if (coordinateX >= 0 && coordinateX < xMax
                    && coordinateY >= 0 && coordinateY < yMax) {
                    pixelsOut[z][x][y + 3] = pixels[coordinateZ][coordinateX][coordinateY];
                } else {
                    pixelsOut[z][x][y + 3] = 255;
                }
            }
    ...
    endTime = clock();
    total += (double)(endTime - startTime) / CLOCKS_PER_SEC;
    cout << "Time for translating the input picture with x-axis offset 200 and y-axis offset 100 is: " << (double)(endTime - startTime) / CLOCKS_PER_SEC << "s" << endl;
